        ...
        >
          ...
          <View style={{ gap: 12 }}>
            <TextInput
              ...
              left={
                <TextInput.Icon icon="account-outline" color={theme.subtext} />
              }
              returnKeyType="next"
            />
            <TextInput
              ...
              activeOutlineColor={theme.accent}
              left={
                <TextInput.Icon icon="email-outline" color={theme.subtext} />
              }
              returnKeyType="next"
            />
            <TextInput
              ...
              activeOutlineColor={theme.accent}
              left={
                <TextInput.Icon icon="lock-outline" color={theme.subtext} />
              }
              returnKeyType="done"
